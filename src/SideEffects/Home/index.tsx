...
//   const onChangeAmount = (x: string) => {
//     setAmount(x);
//     setConvertedAmount(convertCurrency(parseInt(x), currency));
//     setBalance(balanceLeft(parseInt(x)));
//   };
  ...
  return (
    <>
      <Transfer
        ...
        // onChangeRecipient={(x: string) => setRecipient(x)}
